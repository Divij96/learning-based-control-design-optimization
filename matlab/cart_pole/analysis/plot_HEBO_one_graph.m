...
for k=1:4
    if k == 1
        load("python/cart_pole/rl/trained_model/Hebo_eval/CartPole_Hebo_callback_Tanh_Tsteps_12800000_lr_5e-05_hidden_sizes_256_reward_1.00.20.0_pole_length_0.5_freq_1_batchsizeHebo_20.mat")
    elseif k==2
        load("python/cart_pole/rl/trained_model/Hebo_eval/CartPole_Hebo_callback_Tanh_Tsteps_12800000_lr_5e-05_hidden_sizes_256_reward_1.00.20.05_pole_length_0.5_freq_1_batchsizeHebo_20.mat")
    elseif k==3
        load("python/cart_pole/rl/trained_model/Hebo_eval/CartPole_Hebo_callback_Tanh_Tsteps_12800000_lr_5e-05_hidden_sizes_256_reward_1.00.20.1_pole_length_0.5_freq_1_batchsizeHebo_20.mat")
    elseif k==4
        load("python/cart_pole/rl/trained_model/Hebo_eval/CartPole_Hebo_callback_Tanh_Tsteps_12800000_lr_5e-05_hidden_sizes_256_reward_1.00.20.2_pole_length_0.5_freq_1_batchsizeHebo_20.mat")
    end
...
exportgraphics(fig, fullfile(repoRoot, 'outputs', 'cart_pole', 'plots', 'hebo_plots', 'HEBO_results_cart_pole.pdf'), 'ContentType', 'vector');
hold off;
