...
function [joint_acc, pos_tcp] = scara_robot_2dof_FD(q, dq, rho, radius, arm_length, torque)
%#codegen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ROBOT = Planar2DoF(rho, radius, arm_length);
...
TCP_T_EE = [E, [arm_length(2) 0 0]'; o.', 1]; % homogeneous transformation of tcp
