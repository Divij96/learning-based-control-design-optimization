...
% Step 1: Load Data
data1 = readtable(fullfile(repoRoot, 'python', 'scara_2dof_robot', 'result_tb', 'TB_ScaraRobot_FilterOn_length_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_409600000_lr_0.001_hidden_sizes_50_POSreward_1.0_VELreward_0.0_omega_pen_0.0_var_design_PPO_1.csv'));
...
exportgraphics(fig, fullfile(repoRoot, 'outputs', 'robots', 'plots', 'random_design_planar_robot.pdf'), 'ContentType', 'vector');
hold off;
