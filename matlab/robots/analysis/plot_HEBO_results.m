...
drawnow;
exportgraphics(fig2D, fullfile(repoRoot, 'outputs', 'robots', 'plots', 'Robot2DScatterPlot_50designs.pdf'), 'ContentType', 'vector');
...
drawnow;
exportgraphics(fig3D, fullfile(repoRoot, 'outputs', 'robots', 'plots', 'Robot3DScatterPlot.pdf'), 'ContentType', 'vector');
