...
load("src/cart_pole/rl/trained_model/schaff_chop/matlab_data/long_training/CartPole_Schaff_callback_Tanh_Tsteps_61440000_lr_5e-05_hidden_sizes_256_reward_1.00.20.0_pole_length_0.5_freq_1_schaff_lr0.1_0_num_dist_1.mat")
reward_new(1,:) = reward(1,:);
dist_std_new(1,:) = dist_std(1,:);
dist_mean_new(1,:)= dist_mean(1,:);
load("src/cart_pole/rl/trained_model/schaff_chop/matlab_data/long_training/CartPole_Schaff_callback_Tanh_Tsteps_61440000_lr_5e-05_hidden_sizes_256_reward_1.00.20.05_pole_length_0.5_freq_1_schaff_lr0.1_0_num_dist_1.mat")
reward_new(2,:) = reward(1,:);
dist_std_new(2,:) = dist_std(1,:);
dist_mean_new(2,:)= dist_mean(1,:);
load("src/cart_pole/rl/trained_model/schaff_chop/matlab_data/long_training/CartPole_Schaff_callback_Tanh_Tsteps_61440000_lr_5e-05_hidden_sizes_256_reward_1.00.20.1_pole_length_0.5_freq_1_schaff_lr0.1_0_num_dist_1.mat")
reward_new(3,:) = reward(1,:);
dist_std_new(3,:) = dist_std(1,:);
dist_mean_new(3,:)= dist_mean(1,:);
load("src/cart_pole/rl/trained_model/schaff_chop/matlab_data/long_training/CartPole_Schaff_callback_Tanh_Tsteps_61440000_lr_5e-05_hidden_sizes_256_reward_1.00.20.2_pole_length_0.5_freq_1_schaff_lr0.1_0_num_dist_1.mat")
...
exportgraphics(fig, fullfile(repoRoot, 'cartpole_system', 'plots', 'schaff', 'schaff_results_cart_pole.pdf'), 'ContentType', 'vector');
