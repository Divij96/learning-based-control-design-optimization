...
% % Export the 3D plot
% exportgraphics(fig3D, fullfile(repoRoot, 'MultirotorSim_Vervoorst', 'plots', '3DScatterPlot.pdf'), 'ContentType', 'vector');
%
...
% exportgraphics(figXY, fullfile(repoRoot, 'MultirotorSim_Vervoorst', 'plots', 'XY_Plane_ScatterPlot.pdf'), 'ContentType', 'vector');
%
...
% grid on;
% set(gca, 'FontSize', fontSize);
% exportgraphics(figYZ, fullfile(repoRoot, 'MultirotorSim_Vervoorst', 'plots', 'YZ_Plane_ScatterPlot.pdf'), 'ContentType', 'vector');
%
...
% grid on;
% set(gca, 'FontSize', fontSize);
% exportgraphics(figXZ, fullfile(repoRoot, 'MultirotorSim_Vervoorst', 'plots', 'XZ_Plane_ScatterPlot.pdf'), 'ContentType', 'vector');
