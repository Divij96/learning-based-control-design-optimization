...
% Step 1: Load Data
data1 = readtable(fullfile(repoRoot, 'src', 'cart_pole', 'results_tensorboard', 'TB_CartPole_random_design_Tanh_Tsteps_51200000_lr_5e-05_hidden_sizes_256_reward_1.00.20.0_pole_length_1.0_freq_1_PPO_1.csv'));
data2 = readtable(fullfile(repoRoot, 'src', 'cart_pole', 'results_tensorboard', 'TB_CartPole_random_design_Tanh_Tsteps_51200000_lr_5e-05_hidden_sizes_256_reward_1.00.20.05_pole_length_0.5_freq_1_PPO_1.csv'));
data3 = readtable(fullfile(repoRoot, 'src', 'cart_pole', 'results_tensorboard', 'TB_CartPole_random_design_Tanh_Tsteps_51200000_lr_5e-05_hidden_sizes_256_reward_1.00.20.1_pole_length_1.0_freq_1_PPO_1.csv'));
data4 = readtable(fullfile(repoRoot, 'src', 'cart_pole', 'results_tensorboard', 'TB_CartPole_random_design_Tanh_Tsteps_51200000_lr_5e-05_hidden_sizes_256_reward_1.00.20.2_pole_length_1.0_freq_1_PPO_1.csv'));
...
exportgraphics(fig, fullfile(repoRoot, 'cartpole_system', 'plots', 'random_dist', 'random_design_cartpole.pdf'), 'ContentType', 'vector');
hold off;
