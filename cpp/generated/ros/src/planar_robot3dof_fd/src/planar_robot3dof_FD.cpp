...
#include "planar_robot3dof_FD.h"
#include "rtwtypes.h"
#include <cstring>
#include <cmath>
#include "planar_robot3dof_FD_private.h"
 ...
 * solver algorithm
 */
void planar_robot3dof_FD::rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  /* Solver Matrices */
  ...
  /* f0 = f(t,y) */
  rtsiSetdX(si, f0);
  planar_robot3dof_FD_derivatives();
...
void planar_robot3dof_FD::planar_robot3dof_FD_eye(real_T b_I[9])
{
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_diag(const real_T v[3], real_T d[9])
{
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_repmat(real_T b[18])
{
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
boolean_T planar_robot3dof_FD::planar_robot3dof_FD_all(const boolean_T x[3])
{
  int32_T k;
  boolean_T exitg1;
  boolean_T y;
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_mtimes(const real_T A_data[],
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_mtimes_d(const real_T A[36], const
...
void planar_robot3dof_FD::planar_rob_binary_expand_op_ozv(real_T in1[18],
  ...
  const real_T in6[6], const real_T in7[18])
{
  ...
  planar_robot3dof_FD_mtimes_d(in3, in4_data, in4_size, tmp_data, tmp_size);
  in5_0[18] = 0.0;
  in5_0[24] = -in6[2];
  in5_0[30] = in6[1];
  in5_0[19] = in6[2];
  ...
  planar_robot3dof_FD_mtimes_d(in5_0, in4_data, in4_size, tmp_data_0, tmp_size_0);
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_mtimes_dg(const real_T A_data[],
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_mtimes_dgo(const real_T A_data[],
  const int32_T A_size[2], const real_T B_data[], const int32_T B_size[2],
  real_T C_data[], int32_T C_size[2])
{
  int32_T b;
...
void planar_robot3dof_FD::planar_robo_binary_expand_op_oz(real_T in1[9], int32_T
  in2, const real_T in3_data[], const int32_T in3_size[2], const real_T in4[18])
{
  real_T in4_data[18];
  real_T in1_data[9];
  real_T tmp_data[9];
  ...
  planar_robot3dof_FD_mtimes_dgo(in3_data, in3_size, in4_data, in4_size,
    tmp_data, tmp_size);
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_FD_mtimes_dgo5(const real_T A_data[],
...
void planar_robot3dof_FD::planar_robot_binary_expand_op_o(real_T in1[9], int32_T
  in2, const real_T in3[18], real_T in4, const real_T in5[9], const real_T in6[9],
  ...
  real_T in9[18])
{
  ...
  planar_robot3dof_FD_mtimes_dgo5(in3_data, in3_size, in4_0, tmp_data_1,
    tmp_size_0);
  planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_0, in3_data_0, in3_size_0,
    tmp_data, tmp_size);
  in3_size[0] = 6;
  in3_size[1] = in2 + 1;
  for (i = 0; i <= in2; i++) {
  ...
  planar_robot3dof_FD_mtimes_dgo(in8_data, in8_size, in3_data, in3_size,
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof_F_mtimes_dgo5v(const real_T A_data[],
...
/* Function for MATLAB Function: '<S1>/calcSysMatrices' */
void planar_robot3dof_FD::planar_robot3dof__mtimes_dgo5ve(const real_T A_data[],
...
void planar_robot3dof_FD::planar_robot3d_binary_expand_op(real_T in1[3], int32_T
  in2, const real_T in3_data[], const int32_T in3_size[2], const real_T in4[16])
{
  real_T in3_data_0[9];
  real_T in4_0[9];
  real_T tmp_data_0[9];
  ...
  planar_robot3dof_F_mtimes_dgo5v(in3_data_0, in3_size_0, in4_0, tmp_data_0,
    tmp_size_0);
  planar_robot3dof__mtimes_dgo5ve(tmp_data_0, tmp_size_0, tmp_data, &tmp_size);
  in4_tmp = in2 + 1;
  stride_0_1 = (in2 + 1 != 1);
...
/* Model step function */
void planar_robot3dof_FD::step()
{
  if (rtmIsMajorTimeStep((&planar_robot3dof_FD_M))) {
    /* set solver stop time */
    rtsiSetSolverStopTime(&(&planar_robot3dof_FD_M)->solverInfo,
                          (((&planar_robot3dof_FD_M)->Timing.clockTick0+1)*
      (&planar_robot3dof_FD_M)->Timing.stepSize0));
  }                                    /* end MajorTimeStep */

  /* Update absolute time of base rate at minor time step */
  if (rtmIsMinorTimeStep((&planar_robot3dof_FD_M))) {
    (&planar_robot3dof_FD_M)->Timing.t[0] = rtsiGetT(&(&planar_robot3dof_FD_M)
      ->solverInfo);
  }

  {
    ...
    /* Outputs for Atomic SubSystem: '<Root>/planar_robot3dof_FD' */
    /* Integrator: '<S1>/joint_pos_int' incorporates:
     *  Inport: '<Root>/init_pos'
     */
    if (planar_robot3dof_FD_DW.joint_pos_int_IWORK != 0) {
      planar_robot3dof_FD_X.joint_pos_int_CSTATE[0] =
        planar_robot3dof_FD_U.init_pos[0];
      planar_robot3dof_FD_X.joint_pos_int_CSTATE[1] =
        planar_robot3dof_FD_U.init_pos[1];
      planar_robot3dof_FD_X.joint_pos_int_CSTATE[2] =
        planar_robot3dof_FD_U.init_pos[2];
    }
     ...
     *  Inport: '<Root>/rho'
     */
    planar_robot3dof_FD_eye(E_tmp);
    jointOrigins[0] = 0.0;
    jointOrigins[3] = planar_robot3dof_FD_U.arm_length[0];
    jointOrigins[6] = planar_robot3dof_FD_U.arm_length[1];
    m_tmp = planar_robot3dof_FD_U.arm_link_radius *
      planar_robot3dof_FD_U.arm_link_radius;
    m_tmp_0 = m_tmp * 3.1415926535897931;
    m = m_tmp_0 * planar_robot3dof_FD_U.arm_length[0] *
      planar_robot3dof_FD_U.rho;
    rtb_g[0] = planar_robot3dof_FD_U.arm_length[0] / 2.0;
    Iz = 0.25 * m * m_tmp + 0.083333333333333329 * m *
      (planar_robot3dof_FD_U.arm_length[0] * planar_robot3dof_FD_U.arm_length[0]);
    b_m = m;
    ...
    planar_robot3dof_FD_diag(&inertialTwist_pre[0], tmp2);

    /* Integrator: '<S1>/joint_vel_int' */
    planar_robot3dof_FD_B.dq[0] = planar_robot3dof_FD_X.joint_vel_int_CSTATE[0];
    ...
    /* Integrator: '<S1>/joint_vel_int' */
    planar_robot3dof_FD_B.dq[1] = planar_robot3dof_FD_X.joint_vel_int_CSTATE[1];
    ...
    /* Integrator: '<S1>/joint_vel_int' */
    planar_robot3dof_FD_B.dq[2] = planar_robot3dof_FD_X.joint_vel_int_CSTATE[2];

    /* MATLAB Function: '<S1>/calcSysMatrices' incorporates:
     *  Derivative: '<S1>/Derivative_pos_tcp'
     *  Inport: '<Root>/arm_length'
     *  Inport: '<Root>/rho'
     *  Integrator: '<S1>/joint_pos_int'
     */
    jointOrigins[7] = 0.0;
    jointOrigins[8] = 0.0;
    S[6] = 0.0;
    ...
    m = m_tmp_0 * planar_robot3dof_FD_U.arm_length[1] *
      planar_robot3dof_FD_U.rho;
    rtb_g[0] = planar_robot3dof_FD_U.arm_length[1] / 2.0;
    Iz = 0.25 * m * m_tmp + 0.083333333333333329 * m *
      (planar_robot3dof_FD_U.arm_length[1] * planar_robot3dof_FD_U.arm_length[1]);
    c_m = m;
    inertialTwist_pre[0] = 0.5 * m * m_tmp;
    inertialTwist_pre[1] = Iz;
    inertialTwist_pre[2] = Iz;
    ...
    inertialTwist_pre[4] = 0.0;
    inertialTwist_pre[5] = 0.0;
    planar_robot3dof_FD_diag(&inertialTwist_pre[0], b_I);
    b_S[0] = 0.0;
    b_S[3] = 0.0;
    b_S[6] = 0.0;
    b_S[1] = 0.0;
    ...
    m = m_tmp_0 * planar_robot3dof_FD_U.arm_length[2] *
      planar_robot3dof_FD_U.rho;
    rtb_g[0] = planar_robot3dof_FD_U.arm_length[2] / 2.0;
    Iz = 0.25 * m * m_tmp + 0.083333333333333329 * m *
      (planar_robot3dof_FD_U.arm_length[2] * planar_robot3dof_FD_U.arm_length[2]);
    c_S[0] = 0.0;
    c_S[3] = 0.0;
    c_S[6] = 0.0;
    c_S[1] = 0.0;
    ...
    c_S[5] = rtb_g[0];
    c_S[8] = 0.0;
    planar_robot3dof_FD_repmat(ROBOT_csi);
    for (i = 0; i < 3; i++) {
    ...
    inertialTwist_pre[4] = 0.0;
    inertialTwist_pre[5] = 0.0;
    planar_robot3dof_FD_diag(&inertialTwist_pre[0], tmp);
    for (i = 0; i < 3; i++) {
    ...
    for (rtb_CC_0 = 0; rtb_CC_0 < 3; rtb_CC_0++) {
      ...
      m_tmp = planar_robot3dof_FD_B.dq[rtb_CC_0];
      for (i = 0; i < 6; i++) {
      ...
      if (planar_robot3dof_FD_all(ROBOT_csi_0)) {
        m_tmp = planar_robot3dof_FD_X.joint_pos_int_CSTATE[rtb_CC_0];
        for (i = 0; i < 3; i++) {
          O_Htm_tmp_0 = i << 2;
        ...
        jointOrigins[8] = 0.0;
        m = std::sin(planar_robot3dof_FD_X.joint_pos_int_CSTATE[rtb_CC_0]);
        Iz = std::cos(planar_robot3dof_FD_X.joint_pos_int_CSTATE[rtb_CC_0]);
        for (i = 0; i < 3; i++) {
          for (O_Htm_tmp = 0; O_Htm_tmp < 3; O_Htm_tmp++) {
      ...
      planar_robot3dof_FD_mtimes(ROBOT_g0_data, ROBOT_g0_size, O_Htm, Htm_data,
        Htm_size);
      for (i = 0; i < 4; i++) {
        m_tmp = O_Htm_pre[i + 4];
        m = O_Htm_pre[i];
      ...
      if (rtb_CC_0 + 1 > 1) {
        ...
        planar_robot3dof_FD_mtimes_d(invAd, J_pre_data, J_pre_size, tmp_data,
          Htm_size);
        ...
        planar_robot3dof_FD_mtimes_d(invAd, dJ_pre_data, dJ_pre_size, tmp_data,
          Htm_size);
        planar_robot3dof_FD_mtimes_d(m_0, J_pre_data, J_pre_size, tmp_data,
          tmp_size_5);
        if (Htm_size[1] == tmp_size_5[1]) {
          ...
          planar_robot3dof_FD_mtimes_d(m_0, J_pre_data, J_pre_size, dJ_pre_data,
            dJ_pre_size);
          idxStart_4Row = Htm_size[1];
          for (i = 0; i < idxStart_4Row; i++) {
            for (O_Htm_tmp = 0; O_Htm_tmp < 6; O_Htm_tmp++) {
          ...
          planar_rob_binary_expand_op_ozv(dJ, rtb_CC_0, invAd, dJ_pre,
      ...
      planar_robot3dof_FD_mtimes_dg(J_pre, J_size, ROBOT_Mass_data,
      ...
      planar_robot3dof_FD_mtimes_dgo(dJ_pre, Htm_size, J_pre, J_size, b_y,
        tmp_size_5);
      planar_robot3dof_FD_mtimes_dgo(dJ_pre, Htm_size, J_data, J_size_0, b_y,
        tmp_size_4);
      if ((rtb_CC_0 + 1 == tmp_size_5[0]) && (rtb_CC_0 + 1 == tmp_size_4[1])) {
        ...
        planar_robo_binary_expand_op_oz(S, rtb_CC_0, dJ_pre, Htm_size, J);
      }
      ...
      planar_robot3dof_FD_mtimes_dgo5(J_pre, J_size, invAd, tmp_data_1,
        tmp_size_5);
      planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_5, J_data, J_size_0,
        b_y, tmp_size_4);
      planar_robot3dof_FD_mtimes_dgo5(J_data_0, J_size_1, m_0, tmp_data_1,
        tmp_size_5);
      planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_5, J_data_1, J_size_2,
        b_y, tmp_size_0);
      planar_robot3dof_FD_mtimes_dgo5(J_data_2, J_size_3, m_1, tmp_data_1,
        tmp_size_5);
      planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_5, J_data_3, J_size_4,
        b_y, tmp_size_1);
      planar_robot3dof_FD_mtimes_dgo(dJ_pre, Htm_size, dJ_data, dJ_size, b_y,
        tmp_size_5);
      planar_robot3dof_FD_mtimes_dgo5(J_data_4, J_size_5, m_2, tmp_data_1,
        tmp_size_2);
      planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_2, J_data_5, J_size_6,
        b_y, tmp_size_3);
      planar_robot3dof_FD_mtimes_dgo(dJ_pre, Htm_size, dJ_data_0, dJ_size_0, b_y,
        tmp_size_2);
          ...
          ((rtb_CC_0 + 1 == 1 ? tmp_size_3[1] : rtb_CC_0 + 1) == tmp_size_2[1]))
      {
        ...
        planar_robot3dof_FD_mtimes_dgo5(J_pre, J_size, invAd, tmp_data_1,
          tmp_size_4);
        planar_robot3dof_FD_mtimes_dgo(tmp_data_1, tmp_size_4, J_data, J_size_0,
          b_y, tmp_size_5);
        dJ_size[0] = 6;
        dJ_size[1] = rtb_CC_0 + 1;
        for (i = 0; i <= rtb_CC_0; i++) {
        ...
        planar_robot3dof_FD_mtimes_dgo(dJ_pre, Htm_size, dJ_data, dJ_size,
        ...
        planar_robot_binary_expand_op_o(rtb_CC, rtb_CC_0, J, m, jointOrigins,
      ...
      planar_robot3dof_F_mtimes_dgo5v(b_y, tmp_size, jointOrigins, tmp2,
        tmp_size_5);
      planar_robot3dof__mtimes_dgo5ve(tmp2, tmp_size_5, tmp_data_0, &i);
      if (rtb_CC_0 + 1 == i) {
        tmp_size[0] = rtb_CC_0 + 1;
        tmp_size[1] = 3;
        for (i = 0; i < 3; i++) {
        ...
        planar_robot3dof_F_mtimes_dgo5v(b_y, tmp_size, jointOrigins, tmp2,
          Htm_size);
        planar_robot3dof__mtimes_dgo5ve(tmp2, Htm_size, tmp_data_0, &i);
        ...
        planar_robot3d_binary_expand_op(rtb_g, rtb_CC_0, dJ_pre, Htm_size, O_Htm);
      }
    ...
    O_Htm_pre[12] = planar_robot3dof_FD_U.arm_length[2];
    O_Htm_pre[13] = 0.0;
    O_Htm_pre[14] = 0.0;
    O_Htm_pre[3] = 0.0;
    O_Htm_pre[7] = 0.0;
    ...
    planar_robot3dof_FD_B.pos_tcp[0] = O_Htm_0[12];
    planar_robot3dof_FD_B.pos_tcp[1] = O_Htm_0[13];
    planar_robot3dof_FD_B.pos_tcp[2] = O_Htm_0[14];

    /* Derivative: '<S1>/Derivative_pos_tcp' incorporates:
     *  Derivative: '<S1>/Derivative_vel_tcp'
     */
    m = (&planar_robot3dof_FD_M)->Timing.t[0];
    if ((planar_robot3dof_FD_DW.TimeStampA >= m) &&
        (planar_robot3dof_FD_DW.TimeStampB >= m)) {
      /* Derivative: '<S1>/Derivative_pos_tcp' */
      planar_robot3dof_FD_B.Derivative_pos_tcp[0] = 0.0;
      planar_robot3dof_FD_B.Derivative_pos_tcp[1] = 0.0;
      planar_robot3dof_FD_B.Derivative_pos_tcp[2] = 0.0;
    } else {
      Iz = planar_robot3dof_FD_DW.TimeStampA;
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA;
      if (planar_robot3dof_FD_DW.TimeStampA < planar_robot3dof_FD_DW.TimeStampB)
      {
        if (planar_robot3dof_FD_DW.TimeStampB < m) {
          Iz = planar_robot3dof_FD_DW.TimeStampB;
          lastU = &planar_robot3dof_FD_DW.LastUAtTimeB;
        }
      } else if (planar_robot3dof_FD_DW.TimeStampA >= m) {
        Iz = planar_robot3dof_FD_DW.TimeStampB;
        lastU = &planar_robot3dof_FD_DW.LastUAtTimeB;
      }
      ...
      /* Derivative: '<S1>/Derivative_pos_tcp' */
      planar_robot3dof_FD_B.Derivative_pos_tcp[0] =
        (planar_robot3dof_FD_B.pos_tcp[0] - (*lastU)[0]) / Iz;
      planar_robot3dof_FD_B.Derivative_pos_tcp[1] =
        (planar_robot3dof_FD_B.pos_tcp[1] - (*lastU)[1]) / Iz;
      planar_robot3dof_FD_B.Derivative_pos_tcp[2] =
        (planar_robot3dof_FD_B.pos_tcp[2] - (*lastU)[2]) / Iz;
    }

    /* Derivative: '<S1>/Derivative_vel_tcp' */
    if ((planar_robot3dof_FD_DW.TimeStampA_j >= m) &&
        (planar_robot3dof_FD_DW.TimeStampB_n >= m)) {
      /* Outport: '<Root>/TCP_acc' */
      planar_robot3dof_FD_Y.TCP_acc[0] = 0.0;
      planar_robot3dof_FD_Y.TCP_acc[1] = 0.0;
      planar_robot3dof_FD_Y.TCP_acc[2] = 0.0;
    } else {
      Iz = planar_robot3dof_FD_DW.TimeStampA_j;
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA_k;
      if (planar_robot3dof_FD_DW.TimeStampA_j <
          planar_robot3dof_FD_DW.TimeStampB_n) {
        if (planar_robot3dof_FD_DW.TimeStampB_n < m) {
          Iz = planar_robot3dof_FD_DW.TimeStampB_n;
          lastU = &planar_robot3dof_FD_DW.LastUAtTimeB_f;
        }
      } else if (planar_robot3dof_FD_DW.TimeStampA_j >= m) {
        Iz = planar_robot3dof_FD_DW.TimeStampB_n;
        lastU = &planar_robot3dof_FD_DW.LastUAtTimeB_f;
      }
      ...
      /* Outport: '<Root>/TCP_acc' */
      planar_robot3dof_FD_Y.TCP_acc[0] =
        (planar_robot3dof_FD_B.Derivative_pos_tcp[0] - (*lastU)[0]) / Iz;
      planar_robot3dof_FD_Y.TCP_acc[1] =
        (planar_robot3dof_FD_B.Derivative_pos_tcp[1] - (*lastU)[1]) / Iz;
      planar_robot3dof_FD_Y.TCP_acc[2] =
        (planar_robot3dof_FD_B.Derivative_pos_tcp[2] - (*lastU)[2]) / Iz;
    }
    ...
    /* Product: '<S1>/Product3' */
    m_tmp = planar_robot3dof_FD_B.dq[1];
    m = planar_robot3dof_FD_B.dq[0];
    b_m = planar_robot3dof_FD_B.dq[2];
     ...
     */
    for (i = 0; i < 3; i++) {
      tmp_data_0[i] = (planar_robot3dof_FD_U.joint_torque[i] - ((rtb_CC[i + 3] *
    ...
    for (i = 0; i < 3; i++) {
      /* Product: '<S1>/Product1' */
      c_m = (tmp[i + 3] * m_tmp + tmp[i] * m) + tmp[i + 6] * b_m;
      planar_robot3dof_FD_B.Product1[i] = c_m;

      /* Outport: '<Root>/joint_pos' incorporates:
       *  Integrator: '<S1>/joint_pos_int'
       */
      planar_robot3dof_FD_Y.joint_pos[i] =
        planar_robot3dof_FD_X.joint_pos_int_CSTATE[i];

      /* Outport: '<Root>/joint_vel' */
      planar_robot3dof_FD_Y.joint_vel[i] = planar_robot3dof_FD_B.dq[i];

      /* Outport: '<Root>/joint_acc' incorporates:
       *  Product: '<S1>/Product1'
       */
      planar_robot3dof_FD_Y.joint_acc[i] = c_m;

      /* Outport: '<Root>/TCP_pos' */
      planar_robot3dof_FD_Y.TCP_pos[i] = planar_robot3dof_FD_B.pos_tcp[i];

      /* Outport: '<Root>/TCP_vel' */
      planar_robot3dof_FD_Y.TCP_vel[i] =
        planar_robot3dof_FD_B.Derivative_pos_tcp[i];
    }
  ...
  if (rtmIsMajorTimeStep((&planar_robot3dof_FD_M))) {
    ...
    /* Update for Integrator: '<S1>/joint_pos_int' */
    planar_robot3dof_FD_DW.joint_pos_int_IWORK = 0;

    /* Update for Derivative: '<S1>/Derivative_pos_tcp' */
    if (planar_robot3dof_FD_DW.TimeStampA == (rtInf)) {
      planar_robot3dof_FD_DW.TimeStampA = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA;
    } else if (planar_robot3dof_FD_DW.TimeStampB == (rtInf)) {
      planar_robot3dof_FD_DW.TimeStampB = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeB;
    } else if (planar_robot3dof_FD_DW.TimeStampA <
               planar_robot3dof_FD_DW.TimeStampB) {
      planar_robot3dof_FD_DW.TimeStampA = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA;
    } else {
      planar_robot3dof_FD_DW.TimeStampB = (&planar_robot3dof_FD_M)->Timing.t[0];
    ...
    (*lastU)[0] = planar_robot3dof_FD_B.pos_tcp[0];
    (*lastU)[1] = planar_robot3dof_FD_B.pos_tcp[1];
    (*lastU)[2] = planar_robot3dof_FD_B.pos_tcp[2];

    /* End of Update for Derivative: '<S1>/Derivative_pos_tcp' */

    /* Update for Derivative: '<S1>/Derivative_vel_tcp' */
    if (planar_robot3dof_FD_DW.TimeStampA_j == (rtInf)) {
      planar_robot3dof_FD_DW.TimeStampA_j = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA_k;
    } else if (planar_robot3dof_FD_DW.TimeStampB_n == (rtInf)) {
      planar_robot3dof_FD_DW.TimeStampB_n = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeB_f;
    } else if (planar_robot3dof_FD_DW.TimeStampA_j <
               planar_robot3dof_FD_DW.TimeStampB_n) {
      planar_robot3dof_FD_DW.TimeStampA_j = (&planar_robot3dof_FD_M)->Timing.t[0];
      lastU = &planar_robot3dof_FD_DW.LastUAtTimeA_k;
    } else {
    ...
    (*lastU)[0] = planar_robot3dof_FD_B.Derivative_pos_tcp[0];
    (*lastU)[1] = planar_robot3dof_FD_B.Derivative_pos_tcp[1];
    (*lastU)[2] = planar_robot3dof_FD_B.Derivative_pos_tcp[2];

    /* End of Update for Derivative: '<S1>/Derivative_vel_tcp' */
    /* End of Update for SubSystem: '<Root>/planar_robot3dof_FD' */
  }                                    /* end MajorTimeStep */

  if (rtmIsMajorTimeStep((&planar_robot3dof_FD_M))) {
    rt_ertODEUpdateContinuousStates(&(&planar_robot3dof_FD_M)->solverInfo);
     ...
     */
    ++(&planar_robot3dof_FD_M)->Timing.clockTick0;
    (&planar_robot3dof_FD_M)->Timing.t[0] = rtsiGetSolverStopTime
      (&(&planar_robot3dof_FD_M)->solverInfo);

    {
       ...
       */
      (&planar_robot3dof_FD_M)->Timing.clockTick1++;
    }
  }                                    /* end MajorTimeStep */
}

/* Derivatives for root system: '<Root>' */
void planar_robot3dof_FD::planar_robot3dof_FD_derivatives()
{
  XDot_planar_robot3dof_FD_T *_rtXdot;
  _rtXdot = ((XDot_planar_robot3dof_FD_T *) (&planar_robot3dof_FD_M)->derivs);

  /* Derivatives for Atomic SubSystem: '<Root>/planar_robot3dof_FD' */
  /* Derivatives for Integrator: '<S1>/joint_pos_int' */
  _rtXdot->joint_pos_int_CSTATE[0] = planar_robot3dof_FD_B.dq[0];

  /* Derivatives for Integrator: '<S1>/joint_vel_int' */
  _rtXdot->joint_vel_int_CSTATE[0] = planar_robot3dof_FD_B.Product1[0];

  /* Derivatives for Integrator: '<S1>/joint_pos_int' */
  _rtXdot->joint_pos_int_CSTATE[1] = planar_robot3dof_FD_B.dq[1];

  /* Derivatives for Integrator: '<S1>/joint_vel_int' */
  _rtXdot->joint_vel_int_CSTATE[1] = planar_robot3dof_FD_B.Product1[1];

  /* Derivatives for Integrator: '<S1>/joint_pos_int' */
  _rtXdot->joint_pos_int_CSTATE[2] = planar_robot3dof_FD_B.dq[2];

  /* Derivatives for Integrator: '<S1>/joint_vel_int' */
  _rtXdot->joint_vel_int_CSTATE[2] = planar_robot3dof_FD_B.Product1[2];

  /* End of Derivatives for SubSystem: '<Root>/planar_robot3dof_FD' */
}

/* Model initialize function */
void planar_robot3dof_FD::initialize()
{
  /* Registration code */
  ...
  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&(&planar_robot3dof_FD_M)->solverInfo,
                          &(&planar_robot3dof_FD_M)->Timing.simTimeStep);
    rtsiSetTPtr(&(&planar_robot3dof_FD_M)->solverInfo, &rtmGetTPtr
                ((&planar_robot3dof_FD_M)));
    rtsiSetStepSizePtr(&(&planar_robot3dof_FD_M)->solverInfo,
                       &(&planar_robot3dof_FD_M)->Timing.stepSize0);
    rtsiSetdXPtr(&(&planar_robot3dof_FD_M)->solverInfo, &(&planar_robot3dof_FD_M)
                 ->derivs);
    rtsiSetContStatesPtr(&(&planar_robot3dof_FD_M)->solverInfo, (real_T **)
                         &(&planar_robot3dof_FD_M)->contStates);
    rtsiSetNumContStatesPtr(&(&planar_robot3dof_FD_M)->solverInfo,
      &(&planar_robot3dof_FD_M)->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&(&planar_robot3dof_FD_M)->solverInfo,
      &(&planar_robot3dof_FD_M)->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr(&(&planar_robot3dof_FD_M)->solverInfo, &(
      &planar_robot3dof_FD_M)->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&(&planar_robot3dof_FD_M)->solverInfo,
      &(&planar_robot3dof_FD_M)->periodicContStateRanges);
    rtsiSetErrorStatusPtr(&(&planar_robot3dof_FD_M)->solverInfo,
                          (&rtmGetErrorStatus((&planar_robot3dof_FD_M))));
    rtsiSetRTModelPtr(&(&planar_robot3dof_FD_M)->solverInfo,
                      (&planar_robot3dof_FD_M));
  }

  rtsiSetSimTimeStep(&(&planar_robot3dof_FD_M)->solverInfo, MAJOR_TIME_STEP);
  (&planar_robot3dof_FD_M)->intgData.y = (&planar_robot3dof_FD_M)->odeY;
  (&planar_robot3dof_FD_M)->intgData.f[0] = (&planar_robot3dof_FD_M)->odeF[0];
  (&planar_robot3dof_FD_M)->intgData.f[1] = (&planar_robot3dof_FD_M)->odeF[1];
  (&planar_robot3dof_FD_M)->intgData.f[2] = (&planar_robot3dof_FD_M)->odeF[2];
  (&planar_robot3dof_FD_M)->contStates = ((X_planar_robot3dof_FD_T *)
    &planar_robot3dof_FD_X);
  rtsiSetSolverData(&(&planar_robot3dof_FD_M)->solverInfo, static_cast<void *>
                    (&(&planar_robot3dof_FD_M)->intgData));
  rtsiSetIsMinorTimeStepWithModeChange(&(&planar_robot3dof_FD_M)->solverInfo,
    false);
  rtsiSetSolverName(&(&planar_robot3dof_FD_M)->solverInfo,"ode3");
  rtmSetTPtr((&planar_robot3dof_FD_M), &(&planar_robot3dof_FD_M)->Timing.tArray
             [0]);
  (&planar_robot3dof_FD_M)->Timing.stepSize0 = 0.001;
  rtmSetFirstInitCond((&planar_robot3dof_FD_M), 1);

  /* SystemInitialize for Atomic SubSystem: '<Root>/planar_robot3dof_FD' */
  /* InitializeConditions for Integrator: '<S1>/joint_pos_int' */
  if (rtmIsFirstInitCond((&planar_robot3dof_FD_M))) {
    planar_robot3dof_FD_X.joint_pos_int_CSTATE[0] = 0.0;
    planar_robot3dof_FD_X.joint_pos_int_CSTATE[1] = 0.0;
    planar_robot3dof_FD_X.joint_pos_int_CSTATE[2] = 0.0;
  }

  planar_robot3dof_FD_DW.joint_pos_int_IWORK = 1;

  /* End of InitializeConditions for Integrator: '<S1>/joint_pos_int' */

  /* InitializeConditions for Integrator: '<S1>/joint_vel_int' */
  planar_robot3dof_FD_X.joint_vel_int_CSTATE[0] = 0.0;
  planar_robot3dof_FD_X.joint_vel_int_CSTATE[1] = 0.0;
  planar_robot3dof_FD_X.joint_vel_int_CSTATE[2] = 0.0;

  /* InitializeConditions for Derivative: '<S1>/Derivative_pos_tcp' */
  planar_robot3dof_FD_DW.TimeStampA = (rtInf);
  planar_robot3dof_FD_DW.TimeStampB = (rtInf);

  /* InitializeConditions for Derivative: '<S1>/Derivative_vel_tcp' */
  planar_robot3dof_FD_DW.TimeStampA_j = (rtInf);
  planar_robot3dof_FD_DW.TimeStampB_n = (rtInf);

  /* End of SystemInitialize for SubSystem: '<Root>/planar_robot3dof_FD' */

  /* set "at time zero" to false */
  if (rtmIsFirstInitCond((&planar_robot3dof_FD_M))) {
    rtmSetFirstInitCond((&planar_robot3dof_FD_M), 0);
  }
}

/* Model terminate function */
void planar_robot3dof_FD::terminate()
{
  /* (no terminate code required) */
}

/* Constructor */
planar_robot3dof_FD::planar_robot3dof_FD() :
  planar_robot3dof_FD_U(),
  planar_robot3dof_FD_Y(),
  planar_robot3dof_FD_B(),
  planar_robot3dof_FD_DW(),
  planar_robot3dof_FD_X(),
  planar_robot3dof_FD_M()
{
...
planar_robot3dof_FD::~planar_robot3dof_FD() = default;

/* Real-Time Model get method */
RT_MODEL_planar_robot3dof_FD_T * planar_robot3dof_FD::getRTM()
{
  return (&planar_robot3dof_FD_M);
}
