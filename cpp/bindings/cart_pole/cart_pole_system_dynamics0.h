...
struct ExtU_cart_pole_system_dynamic_T {
  ...
  real_T init_pole_pos;                /* '<Root>/init_pole_pos' */
...
struct ExtY_cart_pole_system_dynamic_T {
  ...
  real_T pole_position[2];             /* '<Root>/pole_position' */
  real_T effort;                       /* '<Root>/effort' */
  real_T pole_angular_velocity;        /* '<Root>/pole_angular_velocity' */
  real_T cart_velocity;                /* '<Root>/cart_velocity' */
};
...
struct P_cart_pole_system_dynamics0_T_ {
  ...
  real_T Integrator3_IC;               /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 4/3
...
class cart_pole_system_dynamics0
{
