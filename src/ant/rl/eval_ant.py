...
def main():
    ...
    while True:
        ...
        limb_length = np.array([0.245810490831137,	1.74792355231554,	1.90190336565184,	1.13141192142827,
                                ...
                                0.208594050700340])
        mujoco_file_folder = f"{REPO_ROOT}/src/ant/assets/"
        EVAL_MODEL_PATH = f"{REPO_ROOT}/src/ant/rl/trained_model/allbody/bestGaussDesign_ant_FullGeom_Hebo_Gauss_callback_envs_50_EpLen_1024_lr_0.0001_hid_size_256_FORreward_1.0_CTRLcost_0.0"
