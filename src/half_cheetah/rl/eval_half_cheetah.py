...
def main():
    ...
    while True:
        ...
        # EVAL_MODEL_PATH = f"{REPO_ROOT}/src/half_cheetah/rl/trained_model/random_design/Half_cheetah_dynamics_const_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_12800000_lr_0.0001_hidden_sizes_256_FORreward_1.0_CTRLcost_1.0_var_design"
        # EVAL_MODEL_PATH = f"{REPO_ROOT}/src/half_cheetah/rl/trained_model/random_design/Half_cheetah_dynamics_constant_design_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_12800000_lr_0.0001_hidden_sizes_256_FORreward_1.0_CTRLcost_1.0_var_design"
        EVAL_MODEL_PATH = f"{REPO_ROOT}/src/half_cheetah/rl/trained_model/random_design/Half_cheetah_dynamics_constant_design_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_12800000_lr_0.0001_hidden_sizes_256_FORreward_1.0_CTRLcost_2.0_var_design"
        mujoco_file_folder = f"{REPO_ROOT}/src/half_cheetah/assets/"
