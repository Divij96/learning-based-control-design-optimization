...
def main():
    ...
    EVAL_MODEL_PATH = f"{REPO_ROOT}/src/scara_2dof_robot/rl/trained_model/random_design/ScaraRobot_FilterOn_length_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_409600000_lr_0.001_hidden_sizes_50_POSreward_1.0_VELreward_0.0_omega_pen_0.0_var_design"
