...
class Scara_2Dof_Robot_Env(utils.EzPickle, gym.Env):
    ...
    def step(self, action):
        ...
        reward_speed_x = self.convert_range(obs_vel_tcp[0], self.vel_tcp_range_x[0], self.vel_tcp_range_x[1], 0, 1)
        ...
        reward = reward_speed_x * reward_target
        ...
        #     radius = random.uniform(0, self.arm_length_sum)
