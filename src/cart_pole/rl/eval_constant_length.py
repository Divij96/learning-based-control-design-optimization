...
def main():
    ...
    while True:
        ...
        EVAL_MODEL_PATH = f"{REPO_ROOT}/src/cart_pole/rl/trained_model/constant_mass/{model_name}"
        ...
        matlab_model_path = f"{REPO_ROOT}/src/cart_pole/rl/trained_model/constant_mass/new_matlab_results/{matlab_model_name}.mat"
