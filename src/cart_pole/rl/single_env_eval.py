...
def main():
    ...
    EVAL_MODEL_PATH = f"{REPO_ROOT}/src/cart_pole/rl/trained_model/random_dist/CartPole_random_design_Tanh_Tsteps_51200000_lr_0.0001_hidden_sizes_256_reward_1.00.20.1_pole_length_1.0_freq_1"
...
def evaluate(model, model_name, global_iteration):
    ...
    file_path = f"{REPO_ROOT}/cartpole_system/EVAL_{model_name}.mat"
