    ...
    while True:
        ...
        if EVAL_COUNTER == 1:
            ...
            for i in range(LOOP_COUNT):
                ...
                print(f"steps:{info[0]['steps']:<7.2f} ,reward: {info[0]['reward']:<7.2f}, vel_world: {info[0]['vel_world'][0]:<7.2f} {info[0]['vel_world'][1]:<7.2f} {info[0]['vel_world'][2]:<7.2f}")
