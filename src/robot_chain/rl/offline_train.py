...
def main():
    ...
    log_dir = f"{REPO_ROOT}/src/scara_2dof_robot/PlanarRobot_tensorboard/TB_SAC"
    ...
    model.save(f"{REPO_ROOT}/src/scara_2dof_robot/rl/trained_model/SAC/{model_name}")
...
class Hebo_callback(BaseCallback):
    ...
    def _on_rollout_end(self) -> bool:
        ...
        if self.num_timesteps % self.save_recorded_data == 0:
            ...
            self.model.save(f"{REPO_ROOT}/src/scara_2dof_robot/rl/trained_model/{self.model_name}")
            print("Model saved")
