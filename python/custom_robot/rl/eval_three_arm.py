...
def main():
    ...
    #load the model
    EVAL_MODEL_PATH = f"{REPO_ROOT}/python/custom_robot/rl/trained_model/random_design/PlanarRobot_length_constant_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_107520000_lr_1e-05_hidden_sizes_256_POSreward_1.0_VELreward_0.0_omega_pen_0.0_var_design"
