...
def main():
    ...
    EVAL_MODEL_PATH = f"{REPO_ROOT}/python/robot_chain/rl/trained_model/random_design/ScaraRobot_dynamics_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_20480000_lr_0.0001_hidden_sizes_256_POSreward_1.0_VELreward_0.0_omega_pen_0.0_var_design"
