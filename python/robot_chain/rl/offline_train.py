...
from robot_chain.rl.robot_chain_env import Scara_2Dof_Robot_Env  # Import your custom environment
...
class Hebo_callback(BaseCallback):
    ...
    def _on_rollout_end(self) -> bool:
        ...
        if self.num_timesteps % self.save_recorded_data == 0:
            ...
            file_path = f"{REPO_ROOT}/outputs/robot_chain/{self.mat_file_name}.mat"
            savemat(file_path, output_data)
