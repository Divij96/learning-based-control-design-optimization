...
class Scara_2Dof_Robot_Env(utils.EzPickle, gym.Env):
    ...
    def __init__(self, REWARD = np.array([0.7, 0.0, 0.3]), env_id = 0, arm_length = [1.0, 1.0], call_back = f"random_design"):
        ...
        self.start_pos_tcp = np.array([0.0, 0.0, 0.0], dtype=np.double)
    ...
    def reset(self, seed=None):
        ...
        self.start_pos_tcp = self.pos_tcp.copy()
